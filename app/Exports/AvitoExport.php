...
class AvitoExport extends DefaultValueBinder implements FromView, WithCustomValueBinder
{
    ...
    public function view(): View
    {
        ...
        $products_all = Product::where([['Name', 'not like', '%ставк%'], ['Name', 'not like', '%ступен%'], ['Name', 'not like', '%пецэлем%'], ['balance', 1], ['RMPrice', '>=', '500'], ['Picture', '!=', null]])->whereColumn('RMPrice', '>', 'Price')->get();
