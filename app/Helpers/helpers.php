...
if (!function_exists('avito_surface_leedo')) {
    ...
    function avito_surface_leedo(string|null $surface): string
    {
        ...
        return match ($surface) {
            'антислип, антискользящая', 'матовая', 'матовая, шероховатая', 'структурированная, матовая' => 'Матовая',
            'полуматовая', 'сатинированная, полуглянцевая', 'полуглянцевая', 'структурированная, полуматовая', 'структурированная, полуглянцевая' => 'Лаппатированная (полуполированная)',
            'полированная, глянцевая', 'структурированная и глянцевая', 'рельефная глянцевая' => 'Глянцевая',
...
if (!function_exists('avito_texture_leedo')) {
    ...
    function avito_texture_leedo(string|null $texture): string
    {
        ...
        return match ($texture) {
            'рельефная матовая и глянцевая', 'структурированная и глянцевая', 'рельефная глянцевая', 'структурированная, полуматовая', 'структурированная, полуглянцевая', 'структурированная, матовая' => 'Рельефная (структурированная)',
            default => 'Гладкая',
        };
    }
}
