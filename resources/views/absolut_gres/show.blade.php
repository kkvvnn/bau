...
@section('content')
    ...
    <div class="album py-5 bg-body-tertiary">
        <div class="container">
            ...
            <div>
                <form action="{{ route('save-foto-absolut_gres') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="grid">
                        ...
                        @foreach ($fotos as $foto)
                            <div class="grid-item" style="position: relative; display:inline-block;">
                                <img src="{{$foto}}"/>
                                <form action="{{ route('photo-absolut_gres.delete') }}" method="post">
                                    @csrf
