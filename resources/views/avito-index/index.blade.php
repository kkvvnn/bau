    ...
    <div class="album py-5 bg-body-tertiary">
        <div class="container">
            ...
            @endif
                ...
                <p>60x120 - {{$size_60x120->count()}} шт</p>
                <p>60x60 - {{$size_60x60->count()}} шт</p>
                <p>80x80 - {{$size_80x80->count()}} шт</p>
                <p>80x160 - {{$size_80x160->count()}} шт</p>
                <p>20x120 - {{$size_20x120->count()}} шт</p>
                <p>Всего - {{$size_20x120->count()+$size_80x160->count()+$size_80x80->count()+$size_60x60->count()+$size_60x120->count()}} шт</p>
                <hr>
                <h3>60x120 - {{$size_60x120->count()}} шт</h3>
...
{{--                                @endif--}}
                ...
                <hr>
                <h3>60x60 - {{$size_60x60->count()}} шт</h3>
                    <div class="row row-cols-1 row-cols-md-3 g-4 mt-3">
...
//                        -------------------------
                ...
                <hr>
                <h3>80x80 - {{$size_80x80->count()}} шт</h3>
                    <div class="row row-cols-1 row-cols-md-3 g-4 mt-3">
...
//                        -------------------------
                ...
                <hr>
                <h3>80x160 - {{$size_80x160->count()}} шт</h3>
                    <div class="row row-cols-1 row-cols-md-3 g-4 mt-3">
...
//                        -------------------------
                ...
                <hr>
                <h3>20x120 - {{$size_20x120->count()}} шт</h3>
                    <div class="row row-cols-1 row-cols-md-3 g-4 mt-3">
