...
{{--                    <p class="fs-5">Изображения лиц</p>--}}
                ...
                <div class="col-md-6">
                    ...
                    @if ($product->props->stock_moscow != 0)
                        <h5 class="mt-4 mb-0">Москва: {{$product->props->stock_moscow}} {{$product->unit}} {{$vivod}}</h5>
                    @endif
                    @if ($product->props->stock_krasnodar != 0)
                        <h5 class="mt-0 mb-0">Краснодар: {{$product->props->stock_krasnodar}} {{$product->unit}} {{$vivod}}</h5>
                    @endif
                    {{--                    @if ($stock_spb)--}}
