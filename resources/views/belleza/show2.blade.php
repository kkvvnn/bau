...
@section('meta')
    ...
    <meta property="og:title" content="{{$product->svoystvo}} {{$product->name}} ({{$product->size_b}}x{{$product->size_a}})">
...
{{--                        @endif--}}
                        ...
                        @if($product->thickness && $product->thickness != 0)
                            <tr>
                                ...
                                <td>{{$product->thickness * 10}} мм</td>
                            </tr>
                        @endif
                        @if($product->weight && $product->units_pack)
                            <tr>
                                <th scope="row">Вес упаковки</th>
                                <td>{{round($product->weight * $product->units_pack, 2)}} кг</td>
                            </tr>
                        @endif
