...
//            $description .= '<p><em>Цена указана за 1 ' . $product->MainUnit . '</em></p>';
            ...
            $description .= '<li>просторный шоурум, где можно посмотреть образцы</li>';
            ...
            $description .= '<p><strong>Онлайн отдел отвечает на Ваши вопросы в рабочее время с 10 до 19 (в выходные дни с 10 до 15)</strong></p>';
