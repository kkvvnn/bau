...
//                $description .= '<p><em>* Цена в объявлении актуальна при отгрузке со склада в Москве. При отгрузке со складов в других городах цена может отличаться от указанной.</em></p><br>';
                $description .= '<p><em>Полную стоимость заказа можем рассчитать после понимания формы оплаты, адреса доставки, необходимости разгрузочных работ. Для постоянных клиентов действуют дополнительные скидки.</em></p><ul>';
