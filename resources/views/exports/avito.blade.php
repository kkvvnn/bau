...
{{--        ---------------------BAUSERVICE------------------------}}
        ...
        @php
            ...
            $description .= '<p>Весь октябрь у нас действует <strong>ЧЕСТНАЯ 20% СКИДКА</strong> на всю линейку керамической плитки от Laparet, Vitra и Cersanit. Успей оформить заказ!</p>';
