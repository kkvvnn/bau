...
{{--        ---------------------BAUSERVICE------------------------}}
        ...
        @php
            ...
            $description .= '<p><strong>Весь октябрь у нас действует ЧЕСТНАЯ 20% скидка на всю линейку керамической плитки от Laparet, Vitra и Cersanit. Успей оформить заказ!</strong></p>';
