...
//            $description .= '<p><em>Цена в объявлении указана за 1 ' . $product->MainUnit . '</em></p>';
            ...
            $keywords .= ' керамическая плитка Казань керамогранит Казань Лапарет Казань керамогранит Лапарет керамогранит Laparet плитка купить Лапарет купить Laparet керамогранит';
