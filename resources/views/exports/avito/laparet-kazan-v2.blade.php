    ...
    @foreach($products as $product)
        ...
        @php
            ...
            if ($disc != 'Распродажа' && $disc != 'Вывод из ОА' && $product->Producer_Brand == 'Laparet') {
                $description .= '<p>Цена в объявлении указана за '. $product->MainUnit .' при заказе от <strong>40 тысяч рублей</strong></p>';
            }

            $description .= '<p>Мы являемся официальным Авито магазином бренда '.$product->Producer_Brand.' в Казани. У нас Вы всегда можете увидеть актуальные коллекции керамогранита и керамической плитки Laparet / Ceradim и узнать актуальные остатки.</p>';
...
//            $description .= '<p><em>Цена в объявлении указана за 1 ' . $product->MainUnit . '</em></p>';
            $description .= '<p><em>* Цена актуальна при отгрузке со склада в Казани. При отгрузке со складов в других городах цена может отличаться от указанной.</em></p>';
            ...
            $description .= '<p>Оплата наличными (в офисе), по QR-коду, безналичный расчет</p>';
            $description .= '<p>Возможна отправка транспортной компанией ПЭК</p>';
            ...
            $keywords .= ' керамическая плитка Казань керамогранит Казань Лапарет Казань керамогранит Лапарет керамогранит Laparet плитка купить Лапарет купить Laparet керамогранит распродажа керамогранит';
