...
//                    }
        ...
        @php
            ...
            $description .= '<p>Размер персональной скидки спрашивайте в чате</p>';
    ...
    //        $description .= '<p><em>Цена указана за 1 '.$product->MainUnit.'</em></p>';
            ...
            $description .= '<p><strong>Отгружаем кратно упаковкам. Минимальный заказ - от 1 упаковки. Скидка рассчитывается индивидуально.</strong></p>';
            $description .= '<p>--------------------</p>';
    ...
    //        }
            ...
            $description .= '<li>Официальный шоурум: все образцы в одном месте</li>';
