{{-----PIXMOSAIC-GENERAL----}}
    ...
    @php
        ...
        //            ---TITLE-AVITO--
        $title = 'Мозаика Pixel Mosaic из натурального камня, мрамора, стекла, перламутра';
        //            ---TITLE-AVITO-END--

        //            ---IMAGES---
        $img_1 = 'https://service-plitka.ru/storage/images/pix/pix-1.jpg';
        $img_2 = 'https://service-plitka.ru/storage/images/pix/pix-2.jpg';
        $img_3 = 'https://service-plitka.ru/storage/images/pix/pix-3.jpg';
        $img_4 = 'https://service-plitka.ru/storage/images/pix/pix-4.jpg';
        ...
        $description .= '<p><strong>PIX MOSAIC пиксель мозаик. </strong></p>';
        ...
        $description .= '<p><strong>Под каждый проект действуют индивидуальные условия предоставления скидки, обращайтесь в чат к менеджеру для рассчета.</strong></p>';
                    ...
                    foreach ($pixmosaics as $pix) {
                        $pix_vendor_code_with_space = 'pix ' . str_replace('PIX', '', $pix->vendor_code);
                        $description .= $pix->vendor_code . ' ' . $pix_vendor_code_with_space . ' ';
                    }
                    $description .= '</p>';
