        ...
        $image_2 = Storage::disk('images-hand')->url('rusplitka/2.jpg');
                ...
                $image_urls = $image_2 . ' | ' . $image_main;
                    ...
                    $description .= '<p>'.nl2br($add_description_first).'</p>';
                     ...
                     .= '<p>Керамогранит Bluezone, Colortile. Официальный дилер(работаем уже более 10 лет). Скидки от розничной цены. Доставка по Москве, cамовывоз на западе Москвы.</p>';
