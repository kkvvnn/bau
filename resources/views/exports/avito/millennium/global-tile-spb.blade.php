...
//                }
        ...
        $description .= '<p><strong><em>Минимальная сумма заказа 10000 р.</em></strong></p>';
...
//            if (mb_strlen($title) < 42) { $title = $product->Producer_Brand . ' ' . $title; }
    ...
    @php
        $code = $product->vendor_code.'_millennium_spb';
        $video = '';
    @endphp
...
@endforeach
{{-----GLOBAL-TILE-MILLENNIUM-SPB-END----}}
