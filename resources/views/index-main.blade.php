...
{{--                <img class="d-block mx-auto mb-4" src="/docs/5.3/assets/brand/bootstrap-logo.svg" alt="" width="72" height="57">--}}
                <h1 class="display-5 fw-bold text-body-emphasis">Керамогранит, мозаика, ламинат и многое другое в Москве, <span class="text-nowrap">Санк-Петербурге</span>, Казани</h1>
