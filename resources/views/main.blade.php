...
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page" href="{{route('product_index')}}">LAPARET /--}}
{{--                            CERSANIT / VITRA</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page" href="{{route('kerama-marazzi.index')}}">KERAMA--}}
{{--                            MARAZZI</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
...
{{--                           href="{{route('primavera-new.index')}}">PRIMAVERA</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page"--}}
{{--                           href="{{route('altacera.index')}}">ARTKERA</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page" href="{{route('ntceramic.index')}}">NT--}}
{{--                            CERAMIC</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
...
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page"--}}
{{--                           href="{{route('rusplitka.index')}}">RUSPLITKA</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page" href="{{route('artcenter.index')}}">ART--}}
{{--                            CENTRE</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page" href="{{route('global-tile.index')}}">GLOBAL--}}
{{--                            TILE</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page"--}}
{{--                           href="{{route('kerranova.index')}}">KERRANOVA</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page" href="{{route('keramopro.index')}}">NOVIN--}}
{{--                            CERAM</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page" href="{{route('leedo.index')}}">LEEDO--}}
{{--                            мозаика</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page" href="{{route('pixmosaic-new.index')}}">PIX--}}
{{--                            мозаика</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page" href="{{route('aquafloor_index')}}">AQUAFLOOR--}}
{{--                            кварцвинил</a>--}}
{{--                    </li>--}}
...
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page"--}}
{{--                           href="{{route('product_sale')}}">Распродажа</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page" href="{{route('product_vivod')}}">Вывод из OA--}}
{{--                            Laparet</a>--}}
{{--                    </li>--}}
...
{{--                            <li><a class="dropdown-item" href="https://laparet.ru/" target="_blank">Bauservice</a>--}}
{{--                            </li>--}}
{{--                            <li><a class="dropdown-item" href="https://aquafloors.ru/" target="_blank">Aquafloor</a>--}}
{{--                            </li>--}}
{{--                            <li><a class="dropdown-item" href="https://primavera-opt.ru/"--}}
{{--                                   target="_blank">Primavera</a></li>--}}
{{--                            <li><a class="dropdown-item" href="https://kontact-m.ru/brands/absolut-gres/"--}}
{{--                                   target="_blank">Absolut Gres</a></li>--}}
{{--                            <li><a class="dropdown-item" href="https://www.leedo.ru/" target="_blank">Leedo</a></li>--}}
{{--                            <li><a class="dropdown-item" href="https://altakeramika.ru/"--}}
{{--                                   target="_blank">Altacera</a></li>--}}
{{--                            <li><a class="dropdown-item" href="https://pixmosaic.ru/" target="_blank">PIX Mosaic</a>--}}
{{--                            </li>--}}
{{--                            <li><a class="dropdown-item" href="https://ntceramic.ru/" target="_blank">NT Ceramic</a>--}}
{{--                            </li>--}}
{{--                            <li><a class="dropdown-item" href="https://kevisceramica.ru/" target="_blank">Kevis</a>--}}
{{--                            </li>--}}
{{--                            <li><a class="dropdown-item" href="https://www.rusplitka.ru/"--}}
{{--                                   target="_blank">Rusplitka</a></li>--}}
{{--                            <li><a class="dropdown-item" href="https://technotile.ru/"--}}
{{--                                   target="_blank">Technotile</a></li>--}}
{{--                            <li><a class="dropdown-item" href="https://empero.info/" target="_blank">Empero</a></li>--}}
{{--                        </ul>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" aria-current="page" href="{{route('bauservice.filter')}}">Bauservice--}}
{{--                            filter</a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
