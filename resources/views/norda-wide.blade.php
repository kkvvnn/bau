                ...
                <div class="col-lg-9">
                    <div class="shop-topbar-wrapper">
                        <div class="shop-topbar-left">
                            ...
                            <p>1 - {{ $count_per_page }} из {{ $count_products }} результатов </p>
                        </div>
                        ...
                        <div class="sidebar-widget shop-sidebar-border mb-40 pt-40">
                            ...
                            <div class="sidebar-widget-list">
                                <ul>
                                    ...
                                    <li>
                                        <div class="sidebar-widget-list-left">
                                            <input type="checkbox" value=""> <a href="#">Корчневый <span>9</span> </a>
                                            <span class="checkmark"></span>
                                        </div>
                                    </li>
                                    <li>
...
{{--                                    </div>--}}
                                    ...
                                    <div class="product-details-meta">
                                        <ul>
                                            <li><span>Категории:</span> <a href="#">Woman,</a> <a href="#">Dress,</a> <a href="#">T-Shirt</a></li>
                                            <li><span>Теги: </span> <a href="#">Fashion,</a> <a href="#">Mentone</a> , <a href="#">Texas</a></li>
                                        </ul>
                                    </div>
