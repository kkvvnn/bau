                        ...
                        <div class="pro-dec-big-img-slider">
                            @foreach($urls as $url)
                                <div class="easyzoom-style">
                                    ...
                                    <a class="easyzoom-pop-up img-popup" href="{{$urls[0]}}"><i class="icon-size-fullscreen"></i></a>
                                </div>
                            @endforeach
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-content pro-details-content-mrg">
                        ...
                        <div class="pro-details-price">
                            <span class="new-price">{{ $product->RMPrice }} P</span>
                            @if($product->RMPriceOld)
                                <span class="old-price">{{ $product->RMPriceOld }} P</span>
                            @endif
                        </div>
