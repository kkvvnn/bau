...
@section('title', $search_name??'NT Ceramic')
                ...
                @foreach($products as $product)
                    ...
                    <div class="col">
                        <div class="card h-100">
                            ...
                            <a href="/ntceramic/{{$product->id}}">
                                <img src="{{$product->referer->img1}}" class="card-img-top" alt="...">
                            </a>
                            <div class="card-body">
                                <a href="/ntceramic/{{$product->id}}" class="text-decoration-none text-reset">
                                    <h5 class="card-title">{{$product->brand}} {{$product->referer->title}} {{$product->vendor_code}}</h5>
                                </a>
                                <p class="card-text"></p>
                            </div>
                            <div class="card-footer">
                                ...
                                <p class="text-body-secondary">В упаковке шт:
                                    ...
                                    <strong>{{$product->square_in_pack}}</strong></p>
