                ...
                @foreach($products as $product)
                    ...
                    <div class="col">
                        <div class="card h-100">
                            ...
                            <a href="/primavera/{{$product->id}}">
                                <img src="{{$product->img1}}" class="card-img-top" alt="...">
                            </a>
                            <div class="card-body">
                                <a href="/primavera/{{$product->id}}" class="text-decoration-none text-reset">
                                    <h5 class="card-title">Primavera {{$product->title}}</h5>
                                </a>
                                <p class="card-text"></p>
                            </div>
